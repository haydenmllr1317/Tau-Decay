...
#                                 filterEfficiency = cms.untracked.double(1.0),
    ...
    PGunParameters = cms.PSet(
       ...
       MinPt = cms.double(2.0), #These numbers come from an email from Greg from 9 October 2019
...
#       '553:onIfMatch = 15 -15', # doubt I need this stuff that I commented out, not making any upsilons
      ...
      '15:onIfAll = 211 321 321',
      '15:onIfAll = 321 321 321',
      'TauDecays:mode = 3',  #these TauDecays:etc lines come from the recommendation of Steve Mrena and other gen experts
      'TauDecays:tauPolarization = 0' #no polarization
