...
filepath = '/isilon/export/home/hdmiller/cms_work/Tau-Decay/Decay-Data/CUT_START_Upsilon_nomMass_Total_5May2020.root'
...
def main(datapath, savepath, filetype):
    ...
    df.to_pickle(savepath + "/nomMass_START_Upsilon.pkl")
    return
