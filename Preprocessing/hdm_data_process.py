...
pkl_taup = '/isilon/export/home/hdmiller/Tau-Decay/Pickled-Data/nomMass_JanIdea_taup.pkl'
# pkl_taum = '/Users/gavinpitt/Desktop/taum_file.pkl'
pkl_taum = '/isilon/export/home/hdmiller/Tau-Decay/Pickled-Data/nomMass_JanIdea_taum.pkl'
# pkl_pi = '/Users/gavinpitt/Desktop/pi_file.pkl'
pkl_pi = '/isilon/export/home/hdmiller/Tau-Decay/Pickled-Data/nomMass_JanIdea_pis.pkl'
...
print(df_taup['neu_pt'])

# Compute the histogram
hist1 = histogram1d(df_taup['mass'], bins=bins, range=[range_min, range_max])
# hist2 = histogram1d(pi_neutrino_inv, bins=bins, range=[range_min, range_max])
hist3 = histogram1d(df_pi["neu_phi"], bins=bins, range=[range_min, range_max])
...
plt.title('Invariant Mass of tt Pairs vs 6 Pions')
plt.xlabel('Invariant Mass')
plt.ylabel('Frequency')
# plt.show()
plt.savefig("nom_mass_pis_vs_tau.png")
